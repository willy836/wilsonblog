...
@section('content')
<h1 class="text-center my-4">Welcome to my <span class="blog">blog</span></h1>
@if (count($posts) > 0)
    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-{{ $index === 0 ? '7' : '12' }}">
                            <div class="card-body">
                                <h4>{{ $post->title }}</h4>
                                <p>
                                    By <a href="/authors/{{ $post->author->username }}" class="blog">{{ $post->author->name }}</a> in <a href="/category/{{ $post->category->slug }}/posts" class="blog">{{ $post->category->name }}</a>
                                </p>     
